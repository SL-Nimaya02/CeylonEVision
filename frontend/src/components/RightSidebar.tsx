                            ...
                            <div className="bg-white border border-gray-100 rounded-2xl shadow-xl overflow-hidden animate-in fade-in slide-in-from-right-8 duration-700 ring-1 ring-gray-100">
                                ...
                                <div className="grid grid-cols-3 gap-0 border-t border-b border-gray-100 divide-x divide-gray-100 bg-gray-50/30 text-center">
                                    ...
                                    <div className="p-4 flex flex-col items-center justify-center group hover:bg-white transition-colors">
                                        ...
                                        <p className="text-[9px] text-gray-400 font-medium leading-tight px-1">(to 100%)</p>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    {nextStations.map((station, i) => (
                                        ...
                                        >
                                            <div className="flex justify-between items-center mb-2">
                                                <div className="flex flex-col">
                                                    <h4 className={`font-semibold transition-colors ${expandedStationIndex === i ? 'text-emerald-800 text-base' : 'text-gray-800 text-sm group-hover:text-emerald-700'}`}>
                                                        {station.stationName}
                                                    </h4>
                                                    {expandedStationIndex === i && (
                                                        <div className="flex gap-2 mt-1">
                                                            <span className="text-[10px] text-gray-500 bg-gray-100 px-1.5 py-0.5 rounded flex items-center gap-1">
                                                                <Zap className="w-3 h-3 text-emerald-500" /> {station.power}kW
                                                            </span>
                                                            <span className="text-[10px] text-gray-500 bg-gray-100 px-1.5 py-0.5 rounded flex items-center gap-1 border border-gray-200">
                                                                <Car className="w-3 h-3 text-emerald-500" /> {station.connector}
                                                            </span>
                                                        </div>
                                                    )}
                                                </div>
                                                ...
                                                <div className="flex flex-col gap-2 animate-in fade-in duration-300">
                                                    <div className="flex justify-between items-center text-[11px] text-gray-600">
                                                        ...
                                                        <div className="flex items-center gap-1.5">
                                                            ...
                                                            <span>{station.waitTime}m charge ({station.power}kW)</span>
                                                        </div>
                                                ...
                                                <div className="mt-2 pt-3 border-t border-emerald-100 animate-in slide-in-from-top-2 fade-in duration-300">
                                                    ...
                                                    <div className="grid grid-cols-3 gap-0 border border-emerald-200 rounded-xl divide-x divide-emerald-100 bg-white/60 text-center mb-3">
                                                        ...
                                                        <div className="p-3 flex flex-col items-center justify-center">
                                                            ...
                                                            <p className="text-[8px] text-gray-400 font-medium leading-tight">{station.power}kW Output</p>
                                                        </div>
